...
<ul>
				...
				<li><a href="addwithdraw.php"><span>Our Team</span></a></li>
...
<form name="reg" action="d.php"   method="post">
<fieldset>
  ...
  <td colspan="2">
   ...
   <td><input  type="text" name="rid" placeholder="registration" class="form-control" /></td>
  </tr>
  ...
  <tr>
    ...
    <td><input  type="text" name="topic" placeholder="topic" class="form-control" /></td>
  </tr>
    <tr>
