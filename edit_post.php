...
<div class="pp1" style="height:400px;overflow:scroll;">
        ...
        <form action='' method='post'>
        <div id="inputt">
         Enter Title:<input type='text' name='title' class="textbox" value='<?php echo $post[0]['title']; ?>' />
     </div><br>
     <div class="content_Editrequest">
         Description:<textarea name='contents' cols=80 rows=6><?php echo $post[0]['contents']; ?></textarea>
      </div><br>
       Select catagory:<select name='category'>
        <?php
     ...
     <p><input type='submit' value='Add Request' /></p></p>
     </form>
	 	</div>
