...
<ul>
				 ...
				 <li><a href="uploaderfiles1.php"><span>Upload Documents</span></a></li>
				<li><a href="service.php"><span>Add or withdraw</span></a></li>
...
<div  style="height:600px;width:auto;overflow:scroll;">
    ...
    <tr>
    <td style="color:#1f7898">File Name & (ID Of Student)</td>
    <td style="color:#1f7898">File Type</td>
    <td style="color:#1f7898">File Size(KB)</td>
    <td style="color:#1f7898">View</td>
    </tr>
    <?php
